...
class File(BaseModel):
    ...
    purpose: Optional[str] = Field(description="The purpose of the file, e.g. 'main application logic', 'data processing module', etc.")
...
class Plan(BaseModel):
    ...
    techstack: list[str] = Field(description="The tech stack to be used for the app, e.g. 'python', 'javascript', 'react', 'flask', etc.")
...
class Spec(BaseModel):
    ui_requirements: list[Requirement]
    logic_requirements: list[Requirement]
    integration_rules: list[Requirement]
